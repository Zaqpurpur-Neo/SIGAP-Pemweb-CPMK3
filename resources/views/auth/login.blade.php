<x-guest-layout>
    <div class="mb-8 text-center">
        ...
        <p class="text-sm text-slate-500 mt-1">Masuk ke akun SIGAP Anda</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-between mt-6">
            ...
            <x-primary-button class="ms-3 bg-blue-600 hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:ring-blue-500">
                {{ __('Masuk') }}
            </x-primary-button>
        </div>
    </form>
