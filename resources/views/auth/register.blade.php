<x-guest-layout>
    <div class="mb-8 text-center">
        ...
        <p class="text-sm text-slate-500 mt-1">Daftarkan akun staf untuk sistem SIGAP</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex items-center justify-end mt-6">
            ...
            <x-primary-button class="ms-4 bg-blue-600 hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:ring-blue-500">
                {{ __('Daftar') }}
            </x-primary-button>
        </div>
    </form>
